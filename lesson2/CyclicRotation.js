...
function solution(A, K) {
    if (A.length == 0 || A == null || A == undefined) return []
        // Implement your solution here
    for (let i = 0; i < K; i++) {
        let endValue = A.pop(); // remove last value and assigned to endValue variable
        A.unshift(endValue); // add the endValue to the beginning of Array
    }
    return A;
}

// console.log(solution([1, 2, 3, 4], 1)) // return [2,3,4,1]